...
const products: Product[] = [
  {
    ...
    description: 'Eco-friendly and disposable areca plates perfect for all types of meals.',
    price: '$10 for 25 plates',
  },
  {
    name: 'Areca Cup',
    image: 'https://rukminim2.flixcart.com/image/850/1000/kfikya80/cup-saucer/p/h/j/areca-leaf-cup-tea-cup-catalyst-natural-original-imafvytdgyaed7yg.jpeg?q=90&crop=false', // Replace with actual image path
    description: 'Durable and biodegradable areca cups ideal for both hot and cold beverages.',
    price: '$8 for 50 cups',
  },
  {
    name: 'Areca Spoon',
    image: 'https://www.jiomart.com/images/product/original/rvxvonr3fw/see-inside-disposable-wooden-spoons-25-pcs-amp-wooden-forks-25-pcs-areca-palm-leaf-disposable-wooden-cutlery-set-pack-of-50-product-images-orvxvonr3fw-p605533333-1-202310092356.jpg?im=Resize=(420,420)', // Replace with actual image path
    description: 'Sturdy and compostable areca spoons, great for both casual and formal dining.',
    price: '$5 for 50 spoons',
  },
  {
    name: 'Areca Storage Box',
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRXMQwHNYdPs_Xx7sDYcZTch9ETC8xnj4AZtuICel8sckZEuAnsea6K21_ZmNikXayke2I&usqp=CAU', // Replace with actual image path
    description: 'Stylish and sustainable areca storage boxes for organizing your essentials.',
