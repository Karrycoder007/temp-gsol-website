      ...
      <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center px-20 ">
        ...
        <div className="flex flex-col items-center sm:items-start mb-6 sm:mb-0 px-10">
          ...
          >
            ...
            <p>Email: <a href="" className="hover:text-blue-500">grudhrasolutions@gmail.com</a></p>
          </motion.div>
        </div>
        ...
        <div className="flex flex-col gap-8 text-2xl justify-center items-center sm:items-start">
          ...
          transition={{duration:0.8}}
           className="flex flex-row gap-5 px-3 heading-2">
            ...
            <a href="" className="text-black hover:text-blue-600">Enquiry</a>
            <a href="" className="text-black hover:text-blue-600">Careers</a>
          </motion.div>
          <motion.div
          whileInView={{opacity:1,y:0}}
          initial={{opacity:0,y:100}}
          ...
          <p className="px-2 text-2xl max-sm:text-xl text-center sm:text-left mt-10 text-black">Copyright ©️ 2024 
            <a href="/" className="px-1 text-bold bg-gradient-to-r dark:from-purple-400 to-pink-400 bg-clip-text text-transparent from-purple-600 to-pink-600">
              Team Grudhra
            </a>
          </p>
        </div>
