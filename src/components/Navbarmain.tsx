                ...
                <AnimatePresence>
                  {(isHovered === 'What We Provide' || isDropdownOpen) && (
                    <motion.div 
                      ...
                      transition={{ duration: 0.3 }}
                    >
                      <a href="/iot" className="block px-4 py-2 text-black hover:bg-gray-300" target="_blank">IoT Solutions</a>
          ...
          >
            <div className="flex flex-col gap-4 p-4 text-black">
              ...
              <div className='flex flex-row  text-2xl gap-10 items-center justify-end cursor-pointer'>
                <a href="https://www.linkedin.com/in/coderkarry007/" target="_blank" rel="noopener noreferrer"><FaLinkedinIn className='text-gray-700 hover:text-blue-600 '/></a>
                <a href="https://github.com/Karrycoder007" target='_blank' rel="noopener noreferrer"><FaYoutube className='text-gray-700  hover:text-gray-900'/></a>
                <a href="https://www.instagram.com/yourprofile" target="_blank" rel="noopener noreferrer"><FaInstagram className='text-gray-700 hover:text-pink-500'/></a>
              </div>
            </div>
          </motion.nav>
